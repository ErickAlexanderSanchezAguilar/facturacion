...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2017 a las 00:24:54
...
INSERT INTO `clientes` (`id_cliente`, `ruc_cliente`, `nombre_cliente`, `telefono_cliente`, `email_cliente`, `direccion_cliente`, `status_cliente`, `date_added`) VALUES
(1, '123456', 'juan', '124321421', 'asdasd@gmail.com', 'qweqweqwe', 0, '2017-02-13 18:03:42'),
(2, '12345', 'wq', '2', '214@as.com', 'asdas', 1, '2017-03-22 16:26:44');
...
CREATE TABLE `detalle_factura` (
  ...
  `condicion_factura` tinyint(1) NOT NULL COMMENT '1= activo, 0= anulado'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `detalle_factura` (`id_detalle`, `numero_factura`, `id_producto`, `cantidad`, `precio_venta`, `condicion_factura`) VALUES
(1, 1, 1, 45, 213, 1),
(2, 1, 1, 1, 213, 1);
...
INSERT INTO `facturas` (`id_factura`, `numero_factura`, `fecha_factura`, `id_cliente`, `id_vendedor`, `condiciones`, `total_venta`, `estado_factura`, `condicion_factura`) VALUES
(1, 1, '2017-02-13 18:05:10', 1, 1, '4', '11561.64', 2, 1);
...
(1, 'ACCES BUS S.A.C', 'Colonias Los Andes  #250', 'LIMA', '+51', 'LA VICTORIA', '+(503) 2682-555', 'sistemas@accesbus.com.pe', 18, '$', 'img/1487005543_Logo_660994.png');
...
(1, '22121213132', 'asdasd', 1, '2017-02-13 18:03:20', 213);
...
(1, 'LUIS', 'Alvarado', 'admin', '$2y$10$MPVHzZ2ZPOWmtUUGCq3RXu31OTB.jo7M9LZ7PmPQYmgETSNn19ejO', 'admin@admin.com', '2016-05-21 15:06:00');
